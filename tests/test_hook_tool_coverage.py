...
_MUST_NOT_MATCH = {
    ...
    # Bash is NOT forbidden for these two since v1.8: both read the command
    # itself, and a heredoc or `Set-Content` writes exactly what the Write path
    # refuses. Read tools stay forbidden — those write nothing.
    "memory_pretool_block.py": {"Read", "Grep"},
    "secret_scan.py": {"Read", "Grep"},
