...
Полный MCP-surface: **98 project + 7 brain = 105 инструментов** (опциональный `codebase-rag` добавляет ещё 7; не в основном счёте).
...
```
project_config.py       → DEFAULT_GATES (26 шлюзов)
